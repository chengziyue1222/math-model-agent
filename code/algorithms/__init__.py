...
- monte_carlo: 蒙特卡罗算法 (随机模拟, 排队仿真, 随机游走)
...
from .regression import linear_regression, polynomial_regression, ridge_regression, stepwise_regression, nonlinear_regression
...
from .neural_network import BPNeuralNetwork, RBFNetwork, SOM
from .metaheuristic import genetic_algorithm, particle_swarm, simulated_annealing, ant_colony_tsp
from .cellular_automata import GameOfLife, ForestFire, ElementaryCA, DLA, SIRSModel
from .diagram import (
...
from .monte_carlo import (
    ...
    monte_carlo_simulation, queuing_simulation, random_walk, MCResult,
)
